        ...
        <Tabs defaultValue="preview">
          ...
          >
            <div className="flex items-center gap-[var(--zai-space-element-sm)]">
              ...
              {badge && (
                <span
                  className="text-[10px] px-[var(--zai-space-element-xs)] py-[0.5px] rounded-[var(--zai-radius-default)] font-mono uppercase font-medium"
                  style={{
          ...
          <TabsContent
            value="preview"
            className="p-[var(--zai-space-5)] m-0 min-h-[110px] flex items-center justify-center"
